<template>
  <v-app>
          ...
          <v-form @submit.prevent="submitHandler" ref="form">
            ...
            <v-card-item>
              <div class="alternative-option mt-4">
                ...
                <span class="underline-on-hover" @click="goToLogin">Login</span>
              </div>
            </v-card-item>
    ...
    <v-snackbar top color="green" v-model="successMsg"> Success creating account </v-snackbar>
    <v-snackbar top color="red" v-model="errorMsg"> Error creating account </v-snackbar>
    <v-snackbar top color="red" v-model="accountExists"> Account is already registered </v-snackbar>
