<template>
  <v-app>
          ...
          <v-form @submit.prevent="submitHandler" ref="form">
            ...
            <v-card-item>
              <div class="alternative-option mt-4">
                ...
                <span class="underline-on-hover" @click="goToRegister">Register</span>
              </div>
            </v-card-item>
    ...
    <v-snackbar top color="green" v-model="successMsg"> Login success </v-snackbar>
    <v-snackbar top color="red" v-model="errorMsg"> Error with Login credentials </v-snackbar>
  </v-app>
</template>
